...
public class FlowerShopController {
	...
	public void createTree(int code, String name, float price, int stock,  float height) throws Exception {
		Tree tree = new Tree(code, name, price, stock, height);
		Repository.addItems(tree);	
	}
	
	public void createFlower(int code, String name, float price, int stock,  String color) throws Exception {
		Flower flower = new Flower(code, name, price, stock, color);
		Repository.addItems(flower);	
	}
	
	public void createDecoration(int code, String name, float price, int stock,  String material) throws Exception {
